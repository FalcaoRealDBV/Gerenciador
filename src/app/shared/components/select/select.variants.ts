...
export const selectContentVariants = cva(
  'z-9999 min-w-full scrollbar-hide overflow-y-auto rounded-md border bg-surface-solid text-popover-foreground shadow-lg animate-in fade-in-0 zoom-in-95 backdrop-blur-2xl supports-[backdrop-filter]:bg-surface-solid/90',
);
